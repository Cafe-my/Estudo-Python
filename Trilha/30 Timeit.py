# Mede o tempo de execução de pequenos trechos de código. Ele é útil para comparar o desempenho de diferentes trechos de código, por exemplo, para escolher a melhor abordagem. 
import timeit
